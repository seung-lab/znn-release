...
[image1]
fnames = ../dataset/Semantic/semantic.raw.1.tif
pp_types = standard2D
is_auto_crop = yes

[image2]
fnames = ../dataset/Semantic/semantic.raw.2.tif
pp_types = standard2D
is_auto_crop = yes

[label1]
fnames = ../dataset/Semantic/semantic.lbl.1.tif
pp_types = binary_class
is_auto_crop = yes
fmasks = ../dataset/Semantic/mask.lbl.1.tif 

[label2]
fnames = ../dataset/Semantic/semantic.lbl.2.tif
pp_types = binary_class
is_auto_crop = yes
fmasks = ../dataset/Semantic/mask.lbl.2.tif
