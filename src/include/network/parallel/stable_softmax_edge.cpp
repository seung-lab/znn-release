...
class stable_softmax_edge: public edge
{
public:
    ...
    {
    private:
        std::vector<stable_softmax_edge*> edges_;
        simple_accumulator         accum_;
        task_manager &             tm_   ;

    private:
        void attach(size_t n, stable_softmax_edge* e)
        {
            edges_[n] = e;
            accum_.inc();
        }
        ...
        friend class stable_softmax_edge;
