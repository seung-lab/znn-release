...
int main()
{
    ...
    std::vector<options> nodes3(11);
    std::vector<options> edges3(10);
    ...
    nodes3[0].push("name", "input")
        .push("type", "input")
        .push("size", 1);

    edges3[0].push("name", "conv1")
        .push("type", "conv")
        .push("init", "uniform")
        .push("size", "1,6,6")
        .push("stride", "1,1,1")
    ...
    nodes3[1].push("name", "nl1")
        .push("type", "transfer")
        .push("function", "rectify_linear")
        .push("size", 12);

    edges3[1].push("name", "pool1")
    ...
    nodes3[9].push("name", "nl9")
        .push("type", "transfer")
        .push("function", "rectify_linear")
        .push("size", 48);


    edges3[9].push("name", "conv6")
        .push("type", "conv")
        .push("init", "uniform")
        .push("size", "1,1,1")
        .push("stride", "1,1,1")
    ...
    nodes3[10].push("name", "nl10")
        .push("type", "transfer")
        .push("function", "rectify_linear")
        .push("size", 4);


//     edges3[7].push("name", "conv6")
//         .push("type", "conv")
//         .push("init", "uniform")
//         .push("size", "4,4,4")
//         .push("stride", "1,1,1")
