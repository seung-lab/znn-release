...
#ifndef ZI_CONCURRENCY_DETAIL_PRIORITY_TASK_MANAGER_IMPL_HPP
#define ZI_CONCURRENCY_DETAIL_PRIORITY_TASK_MANAGER_IMPL_HPP 1
...
struct priority_task_manager_impl
    : runnable,
      enable_shared_from_this< priority_task_manager_impl< TaskContainer > >
{
...
public:
    ...
    explicit priority_task_manager_impl( std::size_t worker_limit = 0, std::size_t max_size = 0 ) :
        worker_count_( 0 ),
